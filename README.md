...
ekko-realtime-cli/0.0.1 darwin-x64 node-v14.15.0
$ ekko --help [COMMAND]
USAGE
  $ ekko COMMAND
...
...
_See code: [src/commands/config.js](https://github.com/ekko-live/cli/blob/v0.0.1/src/commands/config.js)_
...
_See code: [src/commands/create.js](https://github.com/ekko-live/cli/blob/v0.0.1/src/commands/create.js)_
...
_See code: [src/commands/deploy.js](https://github.com/ekko-live/cli/blob/v0.0.1/src/commands/deploy.js)_
...
_See code: [src/commands/destroy.js](https://github.com/ekko-live/cli/blob/v0.0.1/src/commands/destroy.js)_
...
_See code: [src/commands/hello.js](https://github.com/ekko-live/cli/blob/v0.0.1/src/commands/hello.js)_
...
_See code: [src/commands/init.js](https://github.com/ekko-live/cli/blob/v0.0.1/src/commands/init.js)_
...
_See code: [src/commands/jwt.js](https://github.com/ekko-live/cli/blob/v0.0.1/src/commands/jwt.js)_
...
_See code: [src/commands/update.js](https://github.com/ekko-live/cli/blob/v0.0.1/src/commands/update.js)_
<!-- commandsstop -->
