...
ekko-realtime-cli/0.0.29 darwin-x64 node-v14.15.0
$ ekko --help [COMMAND]
USAGE
  $ ekko COMMAND
...
...
_See code: [src/commands/config.js](https://github.com/ekko-realtime/cli/blob/v0.0.29/src/commands/config.js)_
...
_See code: [src/commands/create.js](https://github.com/ekko-realtime/cli/blob/v0.0.29/src/commands/create.js)_
...
_See code: [src/commands/deploy.js](https://github.com/ekko-realtime/cli/blob/v0.0.29/src/commands/deploy.js)_
...
_See code: [src/commands/destroy.js](https://github.com/ekko-realtime/cli/blob/v0.0.29/src/commands/destroy.js)_
...
_See code: [src/commands/init.js](https://github.com/ekko-realtime/cli/blob/v0.0.29/src/commands/init.js)_
...
_See code: [src/commands/jwt.js](https://github.com/ekko-realtime/cli/blob/v0.0.29/src/commands/jwt.js)_
...
_See code: [src/commands/status.js](https://github.com/ekko-realtime/cli/blob/v0.0.29/src/commands/status.js)_
...
_See code: [src/commands/teardown.js](https://github.com/ekko-realtime/cli/blob/v0.0.29/src/commands/teardown.js)_
...
_See code: [src/commands/update.js](https://github.com/ekko-realtime/cli/blob/v0.0.29/src/commands/update.js)_
<!-- commandsstop -->
